...
void setup()
{
    ...
    pinMode(GREEN_LED, OUTPUT); //show status of device
    pinMode(RED_LED, OUTPUT); //show status of serial communication
    pinMode(YELLOW_LED, OUTPUT);  //other usage
...
{
    Serial.println("Waiting for commands (help to get command list)"); // send an initial string
}
